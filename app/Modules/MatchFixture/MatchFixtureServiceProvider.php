...
namespace Kalaanba\Modules\MatchFixture;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the MatchFixture engine module.
 *
 * Engine doc (canonical): docs/engines/match-fixture/
 ...
 */
final class MatchFixtureServiceProvider extends ServiceProvider
{
