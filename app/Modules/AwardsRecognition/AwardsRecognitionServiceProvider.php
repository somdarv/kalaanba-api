...
namespace Kalaanba\Modules\AwardsRecognition;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the AwardsRecognition engine module.
 *
 * Engine doc (canonical): docs/engines/awards-recognition/
 ...
 */
final class AwardsRecognitionServiceProvider extends ServiceProvider
{
