...
namespace Kalaanba\Modules\CompetitionRules;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the CompetitionRules engine module.
 *
 * Engine doc (canonical): docs/engines/competition-rules/
 ...
 */
final class CompetitionRulesServiceProvider extends ServiceProvider
{
