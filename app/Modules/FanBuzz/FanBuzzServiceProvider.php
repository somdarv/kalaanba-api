...
namespace Kalaanba\Modules\FanBuzz;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the FanBuzz engine module.
 *
 * Engine doc (canonical): docs/engines/fan-buzz/
 ...
 */
final class FanBuzzServiceProvider extends ServiceProvider
{
