...
namespace Kalaanba\Modules\RpEconomy;

use Illuminate\Support\ServiceProvider;

/**
 * Service provider for the RpEconomy engine module.
 *
 * Engine doc (canonical): docs/engines/rp-economy/
 ...
 */
final class RpEconomyServiceProvider extends ServiceProvider
{
